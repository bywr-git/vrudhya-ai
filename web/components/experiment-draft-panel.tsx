...
export function ExperimentDraftPanel({ experiment }: { experiment: Experiment }) {
  return (
    <section className="phase-panel phase-panel--draft" aria-labelledby="draft-title">
      ...
      <p className="phase-panel__warning">{experiment.status === "measured" ? "MEASUREMENT COMPLETE — SEE THE PERSISTED RESULT BELOW." : "DRAFT ONLY — approval and execution remain separate later steps."}</p>
    </section>
  );
}